...
class UserModel extends DB
{
    ...
    function forgot()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $message = "Xin chào";
            $mail = new PHPMailer(true);  //true: cho phép các trường hợp ngoại lệ
            ...
            try {
                ...
                $nguoigui = 'pmthp2001@gmail.com'; // Tài khoản Email
                $matkhau = 'stghtsopqrzcuzhg'; // Mật khẩu Email
                // $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                // $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                


                // Recipients - Người nhận
                $tennguoigui = 'Coffee House'; // Tên người gửi lấy từ form nhập
                ...
                $to_name = "Tân"; // Tên người cần gửi đến
