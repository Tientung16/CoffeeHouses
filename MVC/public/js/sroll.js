...
$(document).ready(function () {
  ...
  function phantrang(page) {
    ...
    $.ajax({
      url: "http://localhost/coffeeTanTien/home/phantrang",
      method: "POST",
      data: {
        page: page,
        category: category,
  ...
  function showNumAjax(page) {
    var category = getClass("category");
    $.ajax({
      url: "http://localhost/coffeeTanTien/home/showNumAjax",
      method: "POST",
      data: {
        page: page,
        category: category,
...
$("#changepass_form").validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      type: "POST",
      url: "http://localhost/coffeeTanTien/Home/changepass",
      data: $(form).serializeArray(),
      success: function (response) {
        response = JSON.parse(response);
        if (response.status == 0) {
...
$("#edit_user").validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      type: "POST",
      url: "http://localhost/coffeeTanTien/Home/edituser",
      data: $(form).serializeArray(),
      success: function (response) {
        response = JSON.parse(response);
        if (response.status == 0) {
...
$("#form_regsiter").validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      type: "POST",
      url: "http://localhost/coffeeTanTien/Home/RegisterAction",
      data: $(form).serializeArray(),
      success: function (response) {
        response = JSON.parse(response);
        if (response.status == 0) {
...
$("#form_forgot").validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      type: "POST",
      url: "http://localhost/coffeeTanTien/Home/forgotAction",
      data: $(form).serializeArray(),
      success: function (response) {
        response = JSON.parse(response);
        if (response.status == 0) {
...
$("#form_login").validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      type: "POST",
      url: "http://localhost/coffeeTanTien/Home/loginAction",
      data: $(form).serializeArray(),
      success: function (response) {
        response = JSON.parse(response);
        if (response.status == 0) {
          ...
          swal("Thành công!", response.message, "success");
          // location.reload();
          setTimeout("location.href = 'http://localhost/coffeeTanTien/';", 1000);
          $("#login").css("display", "none");
          $(".app").css("opacity", "1");
        }
      },
