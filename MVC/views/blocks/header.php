<header class="header">
  ...
  <div id="menu-area">
    ...
    <div class="logo">
      <a href="<?= BASE_URL ?>" class="logo__link">
        <img class="logo__img" src="<?= BASE_URL ?>/MVC/public/images/coffeetantien.png" alt="Logo-ToCoToCo" />
      </a>
    </div>
  ...
  <div class="banner">
    <div class="banner-text">
      ...
      <p>Với sứ mệnh mang tới niềm vui và hạnh phúc, Coffee House hy vọng sẽ tạo nên <br> một nét văn hóa giải trí bên cạnh ly trà sữa Ngon – sạch – tươi</p>
