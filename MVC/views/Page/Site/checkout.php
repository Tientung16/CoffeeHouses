            ...
            <form action="<?=BASE_URL?>/home/checkoutAct" class="form-checkout" method="post" id="checkoutForm">
                ...
                <div class="content-banking content-banking-none">
                    <div class="box">
                        ...
                        <p>Nội dung: Thanh toán cho đơn hàng của <span class="bold"><?= $row['name'] ?></span></p>
                            <p>Số tiền <span class="b-600"><?= number_format($tongTien, 0, ",", ".") ?> VNĐ</span></p>
                            <p>Chủ tài khoản: <span class="b-600">Coffee House</span></p>
